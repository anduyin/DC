<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:68:"E:\PHPstudy\PHPTutorial\WWW\hisiphp/app/admin\view\upgrade\index.php";i:1544538697;s:61:"E:\PHPstudy\PHPTutorial\WWW\hisiphp\app\admin\view\layout.php";i:1544538697;s:67:"E:\PHPstudy\PHPTutorial\WWW\hisiphp\app\admin\view\block\header.php";i:1544538697;s:65:"E:\PHPstudy\PHPTutorial\WWW\hisiphp\app\admin\view\block\menu.php";i:1544538697;s:66:"E:\PHPstudy\PHPTutorial\WWW\hisiphp\app\admin\view\block\layui.php";i:1544538697;s:71:"E:\PHPstudy\PHPTutorial\WWW\hisiphp\app\admin\view\block\bind_cloud.php";i:1544538697;s:67:"E:\PHPstudy\PHPTutorial\WWW\hisiphp\app\admin\view\block\footer.php";i:1544538697;}*/ ?>
...
layui.use(['jquery', 'layer'], function() {
    ...
    $('.cloudBind').on('click', function() {
        layer.open({
            title:'绑定云平台 / <a href="https://store.hisiphp.com/act/reg?domain=<?php echo $_SERVER["SERVER_NAME"]; ?>" target="_blank" class="mcolor">注册云平台</a>',
            id:'popLoginBox',
            area:'380px',
            ...
            yes:function(index) {
                ...
                $.post('<?php echo url(''); ?>', $('#cloudForm').serialize(), function(res) {
                    if (res.code == 1) {
                        layer.msg(res.msg);
                        setTimeout(function() {
                            location.reload();
