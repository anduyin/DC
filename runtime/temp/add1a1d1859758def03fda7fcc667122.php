<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:67:"E:\PHPstudy\PHPTutorial\WWW\hisiphp/app/admin\view\member\index.php";i:1544538697;s:61:"E:\PHPstudy\PHPTutorial\WWW\hisiphp\app\admin\view\layout.php";i:1544538697;s:67:"E:\PHPstudy\PHPTutorial\WWW\hisiphp\app\admin\view\block\header.php";i:1544538697;s:65:"E:\PHPstudy\PHPTutorial\WWW\hisiphp\app\admin\view\block\menu.php";i:1544538697;s:66:"E:\PHPstudy\PHPTutorial\WWW\hisiphp\app\admin\view\block\layui.php";i:1544538697;s:67:"E:\PHPstudy\PHPTutorial\WWW\hisiphp\app\admin\view\block\footer.php";i:1544538697;}*/ ?>
...
<div class="page-toolbar">
    <div class="page-filter fr">
        <form class="layui-form layui-form-pane" action="<?php echo url(); ?>" id="hisiSearch" method="get">
...
<div class="layui-form">
    ...
    <script type="text/html" id="usernameTpl">
        ...
        <img src="{{ d.avatar ? d.avatar : '/hisiphp/static/admin/image/avatar.png' }}" width="60" height="60" class="fl">
        <p class="ml10 fl"><strong class="mcolor">{{ d.username }} ({{ d.nick }})</strong><br>手机：{{ d.mobile }}<br>邮箱：{{ d.email }}</p></div>
    </script>
    <script type="text/html" id="statusTpl">
        <input type="checkbox" name="status" value="{{ d.status }}" lay-skin="switch" lay-filter="switchStatus" lay-text="正常|关闭" {{ d.status == 1 ? 'checked' : '' }} data-href="<?php echo url('status'); ?>?table=admin_member&id={{ d.id }}">
    </script>
    <script type="text/html" title="操作按钮模板" id="buttonTpl">
        <a href="<?php echo url('edit'); ?>?id={{ d.id }}" class="layui-btn layui-btn-xs layui-btn-normal">修改</a><a href="<?php echo url('del'); ?>?id={{ d.id }}" class="layui-btn layui-btn-xs layui-btn-danger j-tr-del">删除</a>
    </script>
</div>
</form>
