<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:66:"E:\PHPstudy\PHPTutorial\WWW\hisiphp/app/caiwu\view\caiwu\index.php";i:1544539805;s:61:"E:\PHPstudy\PHPTutorial\WWW\hisiphp\app\caiwu\view\layout.php";i:1544539077;s:67:"E:\PHPstudy\PHPTutorial\WWW\hisiphp\app\admin\view\block\header.php";i:1544538697;s:65:"E:\PHPstudy\PHPTutorial\WWW\hisiphp\app\admin\view\block\menu.php";i:1544538697;s:66:"E:\PHPstudy\PHPTutorial\WWW\hisiphp\app\admin\view\block\layui.php";i:1544538697;s:67:"E:\PHPstudy\PHPTutorial\WWW\hisiphp\app\admin\view\block\footer.php";i:1544538697;}*/ ?>
    ...
    <form class="page-list-form">
        ...
        <div class="page-toolbar">
            <div class="layui-btn-group fl">
                ...
                <a data-href="<?php echo url('status?table=不含前缀的表名&val=1'); ?>" class="layui-btn layui-btn-primary j-page-btns layui-icon layui-icon-play" data-table="dataTable">&nbsp;启用</a>
                <a data-href="<?php echo url('status?table=不含前缀的表名&val=0'); ?>" class="layui-btn layui-btn-primary j-page-btns layui-icon layui-icon-pause" data-table="dataTable">&nbsp;禁用</a>
                <a data-href="<?php echo url('del?table=不含前缀的表名'); ?>" class="layui-btn layui-btn-primary j-page-btns confirm layui-icon layui-icon-close red">&nbsp;删除</a>
            </div>
