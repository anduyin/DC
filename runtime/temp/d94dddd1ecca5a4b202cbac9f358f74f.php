<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:67:"E:\PHPstudy\PHPTutorial\WWW\hisiphp/app/admin\view\module\index.php";i:1544538697;s:61:"E:\PHPstudy\PHPTutorial\WWW\hisiphp\app\admin\view\layout.php";i:1544538697;s:67:"E:\PHPstudy\PHPTutorial\WWW\hisiphp\app\admin\view\block\header.php";i:1544538697;s:65:"E:\PHPstudy\PHPTutorial\WWW\hisiphp\app\admin\view\block\menu.php";i:1544538697;s:66:"E:\PHPstudy\PHPTutorial\WWW\hisiphp\app\admin\view\block\layui.php";i:1544538697;s:67:"E:\PHPstudy\PHPTutorial\WWW\hisiphp\app\admin\view\block\footer.php";i:1544538697;}*/ ?>
                    ...
                    <?php if($vo['system'] != 1): ?>
                        <div class="layui-btn-group">
                            <?php switch($vo['status']): case "0": ?>
                                ...
                                <?php break; case "1": if(config('sys.app_debug') && empty($vo['app_keys'])): ?>
                                ...
                                <?php break; case "2": if(config('sys.app_debug') && empty($vo['app_keys'])): ?>
                                        <a href="<?php echo url('edit?id='.$vo['id']); ?>" class="layui-btn layui-btn-primary layui-btn-sm red">编辑</a>
                                    <?php endif; if(!empty($vo['config'])): ?>
                                    <a href="<?php echo url('system/index?group='.$vo['name']); ?>" class="layui-btn layui-btn-primary layui-btn-sm">配置</a>
                                    <?php endif; ?>
