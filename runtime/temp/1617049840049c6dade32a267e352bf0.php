<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:64:"E:\PHPstudy\PHPTutorial\WWW\hisiphp/app/admin\view\user\role.php";i:1544538697;s:61:"E:\PHPstudy\PHPTutorial\WWW\hisiphp\app\admin\view\layout.php";i:1544538697;s:67:"E:\PHPstudy\PHPTutorial\WWW\hisiphp\app\admin\view\block\header.php";i:1544538697;s:65:"E:\PHPstudy\PHPTutorial\WWW\hisiphp\app\admin\view\block\menu.php";i:1544538697;s:66:"E:\PHPstudy\PHPTutorial\WWW\hisiphp\app\admin\view\block\layui.php";i:1544538697;s:67:"E:\PHPstudy\PHPTutorial\WWW\hisiphp\app\admin\view\block\footer.php";i:1544538697;}*/ ?>
...
<head>
    ...
    <link rel="stylesheet" href="/hisiphp/static/admin/js/layui/css/layui.css?v=<?php echo config('hisiphp.version'); ?>">
    <link rel="stylesheet" href="/hisiphp/static/admin/css/theme.css?v=<?php echo config('hisiphp.version'); ?>">
    <link rel="stylesheet" href="/hisiphp/static/admin/css/style.css?v=<?php echo config('hisiphp.version'); ?>">
    <link rel="stylesheet" href="/hisiphp/static/fonts/typicons/min.css?v=<?php echo config('hisiphp.version'); ?>">
    <link rel="stylesheet" href="/hisiphp/static/fonts/font-awesome/min.css?v=<?php echo config('hisiphp.version'); ?>">
</head>
...
<div class="layui-layout layui-layout-admin">
    ...
    <ul class="layui-nav fr nobg head-info">
        <li class="layui-nav-item"><a href="/hisiphp/" target="_blank" class="aicon ai-ai-home" title="前台"></a></li>
...
<?php endif; switch($tab_type): case "1": ?>
    ...
    <div class="layui-btn-group fl">
        <a href="<?php echo url('addRole'); ?>" class="layui-btn layui-btn-primary layui-icon layui-icon-add-circle-fine">&nbsp;添加</a>
        <a data-href="<?php echo url('status?table=admin_role&val=1'); ?>" class="layui-btn layui-btn-primary j-page-btns layui-icon layui-icon-play" data-table="dataTable">&nbsp;启用</a>
        <a data-href="<?php echo url('status?table=admin_role&val=0'); ?>" class="layui-btn layui-btn-primary j-page-btns layui-icon layui-icon-pause" data-table="dataTable">&nbsp;禁用</a>
        <a data-href="<?php echo url('delRole'); ?>" class="layui-btn layui-btn-primary j-page-btns confirm layui-icon layui-icon-close red">&nbsp;删除</a>
    </div>
</div>
<table id="dataTable"></table>
<script src="/hisiphp/static/admin/js/layui/layui.js?v=<?php echo config('hisiphp.version'); ?>"></script>
<script>
    var ADMIN_PATH = "<?php echo $_SERVER['SCRIPT_NAME']; ?>";
    layui.config({
        base: '/hisiphp/static/admin/js/',
        version: '<?php echo config("hisiphp.version"); ?>'
    }).use('global');
</script>
<script type="text/html" id="statusTpl">
    <input type="checkbox" name="status" value="{{ d.status }}" lay-skin="switch" lay-filter="switchStatus" lay-text="正常|关闭" {{ d.status == 1 ? 'checked' : '' }} data-href="<?php echo url('status'); ?>?table=admin_role&id={{ d.id }}">
</script>

<script type="text/html" title="操作按钮模板" id="buttonTpl">
    <a href="<?php echo url('editRole'); ?>?id={{ d.id }}" class="layui-btn layui-btn-xs layui-btn-normal">修改</a>
    <a href="<?php echo url('delRole'); ?>?id={{ d.id }}" class="layui-btn layui-btn-xs layui-btn-danger j-tr-del">删除</a>
</script>
